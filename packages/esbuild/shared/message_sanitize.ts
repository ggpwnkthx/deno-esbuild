 ...
 *   summary text (see {@link ./failure_error.ts}).
 *
 * @see ./failure_error.ts
 */
...
// Back-compat re-export for the existing test import path.
export { failureErrorWithLog } from './failure_error.ts'
